...
function BirdDetail() {
  ...
  return (
    <main className=' bg-white mt-5 container sm:flex-row transition-all '>
      ...
      <div className='mt-3 p-3 transition-all'>
        <p
          className='uppercase text-xl font-bold bg-[#1B1919] py-2 mb-3  text-white cursor-pointer'
      ...
      <div className='mt-3 p-3'>
        <p className='uppercase text-xl font-bold bg-[#1B1919] py-2 mb-3  text-white cursor-pointer'>
